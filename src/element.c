...
// first e last sono l'indice (NON il posto) del primo e dell'ultimo 
// elemento dell'array. Per esempio first = 0 e last = DIM - 1
// ATTENZIONE!! eout va allocato dinamicamenbte usando la dimensione
//  dell'array da ordinare e va liberato con free dopo averlo usato!!!
